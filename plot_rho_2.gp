################# rho plot ####################
# set output "C:/Users/hyoshida/Desktop/figure/rhoN_2.png"
# set terminal png
set output "C:/Users/hyoshida/Desktop/figure/rhoN_2.eps"
...
plot [3.0e+03:5.0e-04][0:10]'C:/Users/hyoshida/Desktop/floquetic/rho_211224_N2_2.dat' u (abs($1)):($2) notitle w l lc "black" lw 1
reset
...
set logscale x
set xtics ("-10^{%L}" 1000,"" 100,"" 10,"-1" 1,"" 0.1,"" 0.01,"-10^{%L}" 1.0e-03)
set xlabel ''
set ylabel ''
set ytics ("0" 0 0, "" 10,"20" 20 0, "" 30, "40" 40 0)
plot [3.0e+03:5.0e-04][0:50]'C:/Users/hyoshida/Desktop/floquetic/rho_211224_N4_2.dat' u (abs($1)):($2) notitle w l lc "black" lw 1
